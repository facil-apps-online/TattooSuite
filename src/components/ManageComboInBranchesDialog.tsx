...
interface ManageComboInBranchesDialogProps {
  combo: Combo | null;
  isOpen: boolean;
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] flex flex-col">
          <DialogHeader>
            <DialogTitle>Gestionar "{combo?.name}" en Sucursales</DialogTitle>
            <DialogDescription>
              Activa o desactiva este combo y gestiona sus precios para cada sucursal.
            </DialogDescription>
          </DialogHeader>
