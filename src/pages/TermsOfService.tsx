        ...
        <CardContent>
          <Tabs defaultValue="es" className="w-full">
            ...
            <TabsContent value="es" className="prose max-w-none mt-4">
              ...
              <p>El Servicio y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de Tattoo Suite y sus licenciantes. El Servicio está protegido por derechos de autor, marcas comerciales y otras leyes tanto de Colombia como de países extranjeros.</p>
            ...
            <TabsContent value="en" className="prose max-w-none mt-4">
                ...
                <p>The Service and its original content, features, and functionality are and will remain the exclusive property of Tattoo Suite and its licensors. The Service is protected by copyright, trademark, and other laws of both Colombia and foreign countries.</p>
